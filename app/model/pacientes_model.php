...
class ArticulosModel extends InitModel{
    private $db;
    private $table = 'articulos';
    private $column = array("nombre","descripcion","cantidad");
    private $column_select = array("id","nombre","descripcion","cantidad");
    private $column_update = array("descripcion","cantidad");
    private $column_filter = array("nombre","descripcion","cantidad");
    private $url;
    ...
    public function personalizado($data){
        try {
